...
senses:
  - label: software engineering
    definition: >
      To establish that a check or claim holds by forcing the observable it
      predicts — a deliberate red run, a called probe, a measured worst
      case — as distinct from inspecting it or watching it pass; frequently
      the thing proven is the instrument itself.
    example: >
